...
export default function Challenges() {
  ...
  const challengeSubmissions = submissions.filter((submission) => 
    !selectedChallenge || submission.challengeId === selectedChallenge
  );
