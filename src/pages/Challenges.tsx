...
export default function Challenges() {
    ...
    const mockTeams: Team[] = [
      {
        id: "team1",
        name: "FC Barcelona",
        logo: "https://images.unsplash.com/photo-1589279715734-6631a314dfa2?q=80&w=1374&auto=format&fit=crop",
        isVerified: true
      },
      {
        id: "team2",
        name: "Manchester United",
        logo: "https://images.unsplash.com/photo-1562099322-45ba2bbfa08d?q=80&w=1470&auto=format&fit=crop",
        isVerified: true
      },
      {
        id: "team3",
        name: "Bayern Munich",
        logo: "https://images.unsplash.com/photo-1593478494840-df89745fd686?q=80&w=1374&auto=format&fit=crop",
        isVerified: true
      },
      {
        id: "team4",
        name: "Local Heroes FC",
        logo: "https://images.unsplash.com/photo-1610201417828-29f95769261b?q=80&w=1376&auto=format&fit=crop",
        isVerified: false
      }
    ];
    ...
    const mockChallenges: Challenge[] = [
      {
        ...
        prizeTiers: [
          {
            tier: "Gold",
            reward: "Signed team jersey"
          },
          {
            tier: "Silver",
            reward: "2 VIP tickets"
          },
          {
            tier: "Bronze",
      ...
      },
      {
        ...
        prizeTiers: [
          {
            tier: "Gold",
            reward: "Meet & greet with team"
          },
          {
            tier: "Silver",
            reward: "Signed football"
          },
          {
            tier: "Bronze",
            reward: "Team merchandise package"
          }
        ],
        submissionCount: 38,
        status: "closed"
      },
      {
        ...
        prizeTiers: [
          {
            tier: "Gold",
            reward: "Academy training session experience"
          },
          {
            tier: "Silver",
            reward: "Limited edition youth team jersey"
          },
          {
            tier: "Bronze",
            reward: "Digital collectibles pack"
          }
        ],
        submissionCount: 24,
        status: "open"
      },
      {
        ...
        prizeTiers: [
          {
            tier: "Gold",
            reward: "Derby day experience package"
          },
          {
            tier: "Silver",
            reward: "Framed historic derby photo"
          },
          {
            tier: "Bronze",
            reward: "Derby day scarf"
          }
        ],
        submissionCount: 12,
        status: "open"
      },
      {
        ...
        prizeTiers: [
          ...
          {
            tier: "Silver",
            reward: "Season tickets"
          },
          {
            tier: "Bronze",
            reward: "Club merchandise"
          }
        ],
        submissionCount: 17,
        status: "open"
  ...
  const handleJoinChallenge = (challengeId: string) => {
    if (!isConnected) {
      toast({
        title: "Wallet not connected",
        description: "Please connect your wallet to join this challenge.",
        variant: "destructive"
      });
      return;
    }
  ...
  return (
    <div className="container px-4 py-8 mx-auto max-w-7xl">
      ...
      {/* Search and create challenge section */}
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {teams.map((team) => (
              <Badge
                key={team.id}
                variant="outline"
                className={`cursor-pointer flex items-center gap-1 ${teamFilter === team.id ? "bg-neon-purple/20 border-neon-purple" : "bg-transparent"}`}
              ...
              >
                ...
                {team.name}
                {team.isVerified && <Check className="h-3 w-3 text-neon-blue" />}
              </Badge>
            ))}
          </div>
      ...
      {filteredChallenges.length > 0 ? (
        ...
        <Card className="bg-goinft-card border-none mb-8">
          <CardContent className="p-10 flex flex-col items-center justify-center">
            ...
            <Button variant="outline" onClick={handleClearFilters}>Reset Filters</Button>
          </CardContent>
        </Card>
      )}

      {/* Challenge submissions section (only visible when a challenge is selected) */}
      {selectedChallenge && (
        <div className="mt-12">
          ...
          {challengeSubmissions.length > 0 ? (
            ...
            <Card className="bg-goinft-card border-none">
              <CardContent className="p-10 flex flex-col items-center justify-center">
                ...
                <Button onClick={() => handleJoinChallenge(selectedChallenge)}>
